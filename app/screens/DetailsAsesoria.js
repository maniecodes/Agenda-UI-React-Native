      ...
      <View key={index} style={styles.itemContainer}>
        <View style={styles.itemBody}>
          <Card
            ...
            <View>
              <Text style={{fontSize: 14, color: '#7E8FB9'}}>{item.date}</Text>
              <Text
                style={{
                  fontWeight: 'bold',
                  fontSize: 12,
      ...
      <View>
        <View
          ...
          <View style={{paddingLeft: 10}}>
            ...
            <Text style={{fontSize: 12, color: '#424049', paddingBottom: 3}}>
              <Text style={{fontWeight: 'bold'}}>Categories: </Text>
              Young . Meditacion hoistca
            </Text>
            <Text style={{fontSize: 12, color: '#424049', paddingBottom: 3}}>
              <Text style={{fontWeight: 'bold'}}>Fecha de asesoria: </Text>{' '}
              18/11/2021
            </Text>
            <Text style={{fontSize: 12, color: '#424049', paddingBottom: 3}}>
              <Text style={{fontWeight: 'bold'}}>Hora: </Text>4:00PM
            </Text>
            <Text style={{fontSize: 12, color: '#424049', paddingBottom: 3}}>
              <Text style={{fontWeight: 'bold'}}>Tiempo: </Text>45 minutos
            </Text>
          </View>
        </View>
      </View>
        ...
        <View style={styles.listTab}>
          {listTab.map(e => (
            <TouchableOpacity
              ...
              {/* <Image
                source={status === e.status ? e.active : e.image}
              ...
              {/* <Icon
                style={[
                  styles.iconTab,
                  status === e.status && styles.iconTabActive,
                ]}
                name={e.icon}
                size={20}
              /> */}
